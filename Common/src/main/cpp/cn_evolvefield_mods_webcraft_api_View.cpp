...
Java_cn_evolvefield_mods_webcraft_api_View_addJSFuncWithCallback(JNIEnv* env_, jobject obj, jlong pointer, jstring jname)
{
...
Java_cn_evolvefield_mods_webcraft_api_WebRenderer_ncreateView(JNIEnv* env_, jobject obj, jlong pointer, jint width, jint height, jboolean transparent,jobject jview)
{
    env = env_;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_WebRenderer_update(JNIEnv* env_, jobject obj, jlong pointer)
{
    env = env_;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_nloadURL(JNIEnv* env_, jobject obj, jlong pointer, jstring str)
{
    env = env_;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_nloadHTML(JNIEnv* env_, jobject obj, jlong pointer, jstring str)
{
    env = env_;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_resize(JNIEnv* env_, jobject obj, jlong pointer, jint width, jint height)
{
...
extern "C"
JNIEXPORT jlong JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_getRTT(JNIEnv* env_, jobject obj, jlong pointer)
{
    env = env_;
...
Java_cn_evolvefield_mods_webcraft_api_View_getRTTTextureID(JNIEnv* env_, jobject obj, jlong pointer)
{
    env = env_;
...
Java_cn_evolvefield_mods_webcraft_api_View_getRTTTop(JNIEnv* env_, jobject obj, jlong pointer)
{
...
extern "C"
JNIEXPORT jfloat JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_getRTTBottom(JNIEnv* env_, jobject obj, jlong pointer)
{
...
extern "C"
JNIEXPORT jfloat JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_getRTTRight(JNIEnv* env_, jobject obj, jlong pointer)
{
...
extern "C"
JNIEXPORT jfloat JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_getRTTLeft(JNIEnv* env_, jobject obj, jlong pointer)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_destroyRTT(JNIEnv* env_, jobject obj, jlong pointer)
{
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_destroyView(JNIEnv* env_, jobject obj, jlong pointer)
{
    RefPtr<View>* view = ((RefPtr<View>*)pointer);
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_nfireScrollEvent(JNIEnv* env_, jobject obj, jlong pointer,jint amount)
{
    env = env_;
    ScrollEvent event;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_nfireMouseEvent(JNIEnv* env_, jobject obj, jlong pointer, jint type, jint button, jint x, jint y)
{
    env = env_;
    MouseEvent event;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_nfireKeyEvent(JNIEnv* env_, jobject obj, jlong pointer, jint type, jint modifiers, jstring str, jint native_code, jint virtual_code)
{
    env = env_;
    KeyEvent event;
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_disable(JNIEnv* env, jobject jview, jlong pointer)
{
    RefPtr<View>* view = ((RefPtr<View>*)pointer);
...
extern "C"
JNIEXPORT void JNICALL
Java_cn_evolvefield_mods_webcraft_api_View_enable(JNIEnv* env, jobject jview, jlong pointer)
{
    RefPtr<View>* view = ((RefPtr<View>*)pointer);
...
Java_cn_evolvefield_mods_webcraft_api_View_evaluateScript(JNIEnv* env_, jobject jview, jlong pointer, jstring jstr)
{
    env = env_;
    RefPtr<View>* view = ((RefPtr<View>*)pointer);
